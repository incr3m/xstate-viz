...
class Tracker {
    ...
    update(id, element) {
        ...
        const data = Object.assign(Object.assign({}, this.elements.get(id)), { element: element || undefined, rect: element ? element.getBoundingClientRect() : undefined, hidden: isHidden(element) });
